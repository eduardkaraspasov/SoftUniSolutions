...
--SELECT EmployeeID, FirstName, LastName, AddressID FROM Employees

--SELECT EmployeeID, FirstName, LastName, JobTitle FROM Employees WHERE JobTitle = 'Design Engineer'
